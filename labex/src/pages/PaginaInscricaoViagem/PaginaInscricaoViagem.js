...
const urlTrip = "https://us-central1-labenu-apis.cloudfunctions.net/labeX/:aluno/trips/:id/apply";
...
const PaginaInscricaoViagem = () => {
    ...
    const onSubmitForm = (event) => {
        ...
        axios
            .post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/:aluno/trips${form.viagemescolhida}/apply`, body)
            .then((response) => {
