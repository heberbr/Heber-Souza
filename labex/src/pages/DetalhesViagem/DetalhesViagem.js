...
const DetalhesViagem = () => {
    ...
    const getTripDetails = () => {
        axios
            .get(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/:aluno/trips/${params.tripId}`, {
                headers: {
    ...
    const decideCandidate = (approve, candidateId) => {
        ...
        axios.put(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/:aluno/trips/${params.tripId}/candidates/${candidateId}/decide`, body, {
            headers: {
                auth: window.localStorage.getItem('token')
            }
        }).then(() => {
